...
CREATE TABLE `sync_logs` (
    ...
    `recordsBefore` INTEGER NOT NULL DEFAULT 0,
    `recordsAfter` INTEGER NOT NULL DEFAULT 0,
    `duration` INTEGER NULL,
    `metadata` JSON NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),

    INDEX `sync_logs_source_entityType_idx`(`source`, `entityType`),
...
CREATE TABLE `sync_config` (
    ...
    UNIQUE INDEX `sync_config_source_key`(`source`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
